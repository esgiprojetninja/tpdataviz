<?php
	...
	*/
    ...
    $query = "select * from messages as m left join relations as r on ((r.user1=3 and m.destinataire=r.user2) or (r.user1=m.destinataire and r.user2=3)) where emetteur=3;";
